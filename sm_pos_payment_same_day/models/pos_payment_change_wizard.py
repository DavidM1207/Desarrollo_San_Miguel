    ...
    def _create_approval_requests(self):
        ...
        for line in self.new_line_ids:
            request_vals = {
                ...
                'voucher_amount': line.amount,  # Monto del comprobante
                'pos_order_id': order.id,
                'state': 'pending',
                # payment_document_id se asignará después por el aprobador
                # approver_id se asigna automáticamente en el create
            }
